...
class ShowMoreUsersFragment : Fragment() {
    private lateinit var usersAdapter: UsersAdapter

    private lateinit var viewModel: ShowMoreUsersViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this,
            ...
            .get(ShowMoreUsersViewModel::class.java)
    ...
    private fun initializeList() {
        binding.list.apply {
            ...
            usersAdapter.listener = object: AdapterInterfaces.UsersAdapterEventListener{
            ...
            viewModel.criticsList.observe(viewLifecycleOwner, { criticsList ->
                usersAdapter.setDataSet(criticsList as ArrayList<User>)
